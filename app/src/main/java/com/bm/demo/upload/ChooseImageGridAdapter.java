...
import com.bm.demo.upload.BitmapCache.ImageCallback;
...
public class ChooseImageGridAdapter extends BaseAdapter {
    ...
    public ChooseImageGridAdapter(Activity act, List<ImageItem> list, Handler mHandler) {
        this.act = act;
        dataList = list;
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            holder = new Holder();
            convertView = View.inflate(act, R.layout.item_chooseimage_grid, null);
